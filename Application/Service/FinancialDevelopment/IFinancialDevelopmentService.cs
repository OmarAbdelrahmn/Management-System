...
public interface IFinancialDevelopmentService
{
    ...
    Task<Result<FundraisingOpportunityResponse>> CompleteOpportunityAsync(int id, CompleteFundraisingOpportunityRequest request, CancellationToken cancellationToken = default);
    ...
    Task<Result<DonationContributionResponse>> UpdateContributionStatusAsync(int id, UpdateDonationContributionStatusRequest request, CancellationToken cancellationToken = default);
    Task<Result<IEnumerable<DonationContributionActivityResponse>>> GetContributionActivitiesAsync(int contributionId, CancellationToken cancellationToken = default);
    ...
    Task<Result<DigitalCampaignDonationResponse>> RecordDigitalCampaignDonationAsync(int id, RecordDigitalCampaignDonationRequest request, CancellationToken cancellationToken = default);
    ...
    Task<Result<AbandonedDonationCartRecoveryResponse>> RecoverAbandonedCartAsync(int id, RecoverAbandonedDonationCartRequest request, CancellationToken cancellationToken = default);
    ...
    Task<Result<EndowmentInvoicePaymentResponse>> PayEndowmentInvoiceAsync(int id, PayEndowmentInvoiceRequest request, CancellationToken cancellationToken = default);
}
