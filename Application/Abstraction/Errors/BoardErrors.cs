...
public static class BoardErrors
{
    ...
    public static readonly Error InvalidRequest = new("Board.InvalidRequest", "Board request is invalid.", StatusCodes.Status400BadRequest);
    public static readonly Error DuplicateCode = new("Board.DuplicateCode", "Board code is already used.", StatusCodes.Status409Conflict);
}
