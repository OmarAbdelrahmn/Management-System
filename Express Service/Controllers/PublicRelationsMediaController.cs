...
[ApiController]
[RequirePermissionPrefix("system.pr-media.")]
public class PublicRelationsMediaController(IPublicRelationsMediaService service) : ControllerBase
{
    ...
    public async Task<IActionResult> UpdatePartner(int id, [FromBody] SaveMediaPartnerRequest request, CancellationToken ct) => ToAction(await service.SavePartnerAsync(id, request, ct));
    [HttpGet("events")]
    ...
    public async Task<IActionResult> UpdateEvent(int id, [FromBody] SaveMediaEventRequest request, CancellationToken ct) => ToAction(await service.SaveEventAsync(id, request, ct));
    [HttpGet("visits")]
    ...
    public async Task<IActionResult> UpdateVisit(int id, [FromBody] SaveMediaVisitRequest request, CancellationToken ct) => ToAction(await service.SaveVisitAsync(id, request, ct));
    ...
    [HttpPut("website-users/{id:int}")]
    public async Task<IActionResult> UpdateWebsiteUser(int id, [FromBody] SaveWebsiteUserAccountRequest request, CancellationToken ct) => ToAction(await service.SaveWebsiteUserAsync(id, request, ct));
    ...
    public async Task<IActionResult> UpdateTemplate(int id, [FromBody] SaveCommunicationTemplateRequest request, CancellationToken ct) => ToAction(await service.SaveTemplateAsync(id, request, ct));
    [HttpGet("lists")]
    ...
    public async Task<IActionResult> UpdateList(int id, [FromBody] SaveCommunicationListRequest request, CancellationToken ct) => ToAction(await service.SaveListAsync(id, request, ct));
    [HttpGet("campaigns")]
    ...
    public async Task<IActionResult> UpdateCampaign(int id, [FromBody] SaveCommunicationCampaignRequest request, CancellationToken ct) => ToAction(await service.SaveCampaignAsync(id, request, ct));
    ...
    [HttpPut("push-subscribers/{id:int}")]
    public async Task<IActionResult> UpdatePushSubscriber(int id, [FromBody] SavePushSubscriberRequest request, CancellationToken ct) => ToAction(await service.SavePushSubscriberAsync(id, request, ct));
    [HttpGet("design")]
    ...
    [HttpPut("design/{id:int}")]
    public async Task<IActionResult> UpdateDesign(int id, [FromBody] SaveWebsiteDesignSettingRequest request, CancellationToken ct) => ToAction(await service.SaveDesignSettingAsync(id, request, ct));
    [HttpGet("navigation")]
    ...
    public async Task<IActionResult> UpdateNavigation(int id, [FromBody] SaveWebsiteNavigationItemRequest request, CancellationToken ct) => ToAction(await service.SaveNavigationItemAsync(id, request, ct));
    [HttpGet("content")]
    ...
    [HttpPut("content/{id:int}")]
    public async Task<IActionResult> UpdateContent(int id, [FromBody] SaveWebsiteContentItemRequest request, CancellationToken ct) => ToAction(await service.SaveContentItemAsync(id, request, ct));
    [HttpPost("content/{id:int}/status")]
    public async Task<IActionResult> UpdateContentStatus(int id, [FromBody] UpdateWebsiteContentStatusRequest request, CancellationToken ct) => ToAction(await service.UpdateContentStatusAsync(id, request, ct));
    [HttpGet("forms")]
    ...
    public async Task<IActionResult> UpdateForm(int id, [FromBody] SaveWebsiteFormRequest request, CancellationToken ct) => ToAction(await service.SaveFormAsync(id, request, ct));
    ...
    [HttpPut("contact-requests/{id:int}")]
    public async Task<IActionResult> UpdateContactRequest(int id, [FromBody] SaveWebsiteContactRequestRequest request, CancellationToken ct) => ToAction(await service.SaveContactRequestAsync(id, request, ct));
